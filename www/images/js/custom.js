...
/*	var width = $(window).width();
	...
	$(function(){
		...
		// Financial Page Checkbox Function Start here	
			$('body').append('<div class="overlay-box" style="display:none;"></div>')
			$('.financial-table .iCheck-helper').click(function(){				
       		if($('.overlay-box').is(':hidden')) { 					
					...
					$(this).parents('section').find('.icheckbox_square-blue').css('z-index','');
				}
			});
   			
        // Financial Page Checkbox Function End here
